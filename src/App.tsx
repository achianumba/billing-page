  ...
  return (
    <BrowserRouter>
      <div className="App" ref={appRef}>
          ...
          <div className="sidebar__header">
            <Link to="#" className="user__info__link">
              ...
              <div className="user__info">
                ...
                <Text
                  content="@janedoe"
                  className="text--dark-2 user__handle"
                />
              </div>
            </Link>
        ...
        <p>
          Designed by
          <Link to="https://www.uidesigndaily.com/posts/figma-billing-page-payment-day-1585">
            Ildiko Gaspar
          </Link>{' '}
          and coded by{' '}
          <Link to="https://github.com/achianumba">Arinze Chianumba</Link>
        </p>
      </footer> */}
      </div>
    </BrowserRouter>
